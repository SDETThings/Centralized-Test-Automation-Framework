...
public class WEBDataProvider extends BaseClass {
...
tl.get()[index][x] = groupName;
    ...
    public Object[] ConfigureTestCaseData(Method method) throws IOException {
        JsonOperations jsonOperations = new JsonOperations();
        MasterDataUtils masterDataUtils = new MasterDataUtils();
        String testCaseId = method.getName();
        JsonArray iterationDetailsArray;
        ...
        synchronized (WEBDataProvider.class) {
            iterationDetailsArray  = masterDataUtils.getIterationDataSetsFromMasterData(testCaseId, FrameworkComponentKeys.WEB.getComponentAsString(), completeMasterData);
